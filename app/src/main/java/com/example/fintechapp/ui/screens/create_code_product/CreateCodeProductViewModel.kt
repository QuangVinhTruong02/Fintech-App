...
class CreateCodeProductViewModel(
                ...
                try {
                    ...
                    if (response is ResultApi.Success) {
                        if (response.data != null) {
                            ...
                            _uiImageState.emit(UIState.Failure(Exception(AppLanguage.SOMETHING_WENT_WRONG)))
                        }
                    } else {
    ...
    fun onCreateProduct(
        ...
        viewModelScope.launch {
            try {
                ...
                val response =
                    codeProductRepository.createProduct(codeProductRequest = codeProductRequest)
                if (response is ResultApi.Success) {
