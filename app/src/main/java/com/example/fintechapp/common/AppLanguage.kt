...
object AppLanguage {
    ...
    const val ADVERTISING_TIME = "Advertising time"
    const val ACTIVE = "Active"
    const val CODE_SCANNING_TIME = "Code scanning time"
    const val SAVE = "Save"
    const val QUANTITY_MUST_BE_A_NUMBER=  "Quantity must be a number"
    const val SUCCESSFULLY_UPDATE_ADVERTISEMENT = "Successfully update advertisement"
    const val SUCCESSFULLY_UPDATE_CODE_SCAN_TIME = "Successfully update code scan time"
    const val PRODUCT_NAME = "Product name"
    const val NEXT_PRODUCT = "Next product"
    const val DESCRIPTION = "Description"
    const val UNKNOWN = "Unknown"
    const val NEW_PRODUCT = "New product"
    const val CREATE_PRODUCT = "New product"
    const val UPDATE_PRODUCT = "Update product"
    const val PRODUCT_LIST = "Product list"
    const val NAME_PRODUCT = "Name product"
    const val SELECT_IMAGE = "Select image"
    const val ENTER_NAME_PRODUCT = "Enter name product"
    const val THERE_ARE_NO_PRODUCTS = "There are no products"
    const val DELETE_PRODUCT = "Delete product"
    const val ARE_YOU_SURE_YOU_WANT_TO_DELETE_THIS_PRODUCT =
